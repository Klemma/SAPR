...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_7 = QtWidgets.QGridLayout(self.calculations_tab)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.confirm_btn = QtWidgets.QPushButton(self.calculations_tab)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.confirm_btn.setFont(font)
        self.confirm_btn.setObjectName("confirm_btn")
        self.gridLayout_7.addWidget(self.confirm_btn, 2, 0, 1, 1)
        self.sampling_label = QtWidgets.QLabel(self.calculations_tab)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.sampling_label.setFont(font)
        self.sampling_label.setObjectName("sampling_label")
        self.gridLayout_7.addWidget(self.sampling_label, 0, 0, 1, 1)
        self.sampling_spinbox = QtWidgets.QDoubleSpinBox(self.calculations_tab)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.sampling_spinbox.setFont(font)
        self.sampling_spinbox.setObjectName("sampling_spinbox")
        self.gridLayout_7.addWidget(self.sampling_spinbox, 1, 0, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_7.addItem(spacerItem, 1, 1, 1, 1)
        self.calculate_section_btn = QtWidgets.QPushButton(self.calculations_tab)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.calculate_section_btn.setFont(font)
        self.calculate_section_btn.setObjectName("calculate_section_btn")
        self.gridLayout_7.addWidget(self.calculate_section_btn, 2, 2, 1, 1)
        self.section_input = QtWidgets.QLineEdit(self.calculations_tab)
        ...
        self.gridLayout_7.addWidget(self.section_input, 1, 2, 1, 1)
        self.section_label = QtWidgets.QLabel(self.calculations_tab)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.gridLayout_7.addWidget(self.section_label, 0, 2, 1, 1)
        self.Nx_section_label = QtWidgets.QLabel(self.calculations_tab)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Nx_section_label.setFont(font)
        self.Nx_section_label.setObjectName("Nx_section_label")
        self.gridLayout_7.addWidget(self.Nx_section_label, 0, 3, 1, 1)
        self.Ux_section_label = QtWidgets.QLabel(self.calculations_tab)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Ux_section_label.setFont(font)
        self.Ux_section_label.setObjectName("Ux_section_label")
        self.gridLayout_7.addWidget(self.Ux_section_label, 1, 3, 1, 1)
        self.Sx_section_label = QtWidgets.QLabel(self.calculations_tab)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Sx_section_label.setFont(font)
        self.Sx_section_label.setObjectName("Sx_section_label")
        self.gridLayout_7.addWidget(self.Sx_section_label, 2, 3, 1, 1)
        self.calculations_table = QtWidgets.QTableWidget(self.calculations_tab)
        self.calculations_table.setEnabled(True)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.calculations_table.setFont(font)
        self.calculations_table.setObjectName("calculations_table")
        self.calculations_table.setColumnCount(4)
        self.calculations_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.calculations_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.calculations_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.calculations_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.calculations_table.setHorizontalHeaderItem(3, item)
        self.calculations_table.horizontalHeader().setDefaultSectionSize(250)
        self.calculations_table.horizontalHeader().setStretchLastSection(True)
        self.gridLayout_7.addWidget(self.calculations_table, 3, 0, 1, 4)
        self.postprocessor_tab_widget.addTab(self.calculations_tab, "")
        ...
        self.calculate_action = QtWidgets.QAction(MainWindow)
        self.calculate_action.setObjectName("calculate_action")
        self.file_menu.addAction(self.open_action)
        self.file_menu.addAction(self.save_action)
        self.processor_menu.addAction(self.calculate_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sampling_label.setText(_translate("MainWindow", "Шаг дискретизации"))
        self.calculate_section_btn.setText(_translate("MainWindow", "Рассчитать"))
        ...
        item = self.calculations_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "x"))
        item = self.calculations_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "N(x)"))
        item = self.calculations_table.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "U(x)"))
        item = self.calculations_table.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "S(x)"))
        self.postprocessor_tab_widget.setTabText(self.postprocessor_tab_widget.indexOf(self.calculations_tab), _translate("MainWindow", "Результаты расчетов"))
        ...
        self.calculate_action.setText(_translate("MainWindow", "Провести расчет"))
